		 <section class="content">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<h3><strong>Nuevo Tipo de Usuario</strong></h3>
				@if (count($errors)>0)
				...
				@endif
				{!! Form::open(array('url'=>'docente/tipodocente','method'=>'POST','autocomplete'=>'off'))!!}
				{{Form::token()}}
				<div class="form-group">
					<label for="nombre">Nombre</label>
					<input type="text" name="nombre" class="form-control"  required="true" placeholder="Nombre..." >
				</div>			
				<div class="form-group">
